# TAKEN FROM https://github.com/GarettMorrison/Procedural_MIDI all credit to Garett Morrison for the generated melody method
...
alto_out = mido.open_output('IAC Driver Bus 3')
...
try:
    while(True):
        ...
        if not plt.fignum_exists(fig.number):
            print("\nPlot window closed, stopping gracefully...")
            for outport in outportSets:
